...
type TETRAEDRETillquistDIZData struct {
	Time        time.Time
...
type decodedTETRAEDRETillquistDIZdata struct {
	...
	Data      []TETRAEDRETillquistDIZData `json:"data,omitempty"`
}
...
func parseTETRAEDRETillquistDIZDataData(receivedtime time.Time, port uint8, receiveddata string) []TETRAEDRETillquistDIZData {
...
//fmt.Println("str=",str)
	...
	var parsedvalues []TETRAEDRETillquistDIZData
              ...
              fmt.Println("len(databytes):", len(databytes))
                ...
                parsedvalues = make([]TETRAEDRETillquistDIZData, capacity)
...
func publishTETRAEDRETillquistDIZData(dev device, entry loradata, parsedvalues []TETRAEDRETillquistDIZData) {
